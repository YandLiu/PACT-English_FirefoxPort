import { _ as __vitePreload, b as boot } from "./index.454a89f7.js";
...
var enhanceError$3 = function enhanceError(error, config2, code, request2, response) {
...
var createError$3 = function createError(message, config2, code, request2, response) {
  var error = new Error(message);
  return enhanceError$2(error, config2, code, request2, response);
};
...
var xhr = function xhrAdapter(config2) {
  return new Promise(function dispatchXhrRequest(resolve, reject) {
    ...
    request2.onabort = function handleAbort() {
      ...
      reject(createError$1("Request aborted", config2, "ECONNABORTED", request2));
      request2 = null;
    };
    request2.onerror = function handleError2() {
      reject(createError$1("Network Error", config2, null, request2));
      request2 = null;
    };
...
const author$1 = "Matt Zabriskie";
const license$1 = "MIT";
const bugs = {
  url: "https://github.com/axios/axios/issues"
};
const homepage$1 = "https://axios-http.com";
...
var axios$4 = createInstance(defaults);
axios$4.Axios = Axios;
axios$4.create = function create(instanceConfig) {
  return createInstance(mergeConfig2(axios$4.defaults, instanceConfig));
};
axios$4.Cancel = Cancel_1;
axios$4.CancelToken = CancelToken_1;
axios$4.isCancel = isCancel$1;
axios$4.all = function all(promises) {
  return Promise.all(promises);
};
axios$4.spread = spread;
axios$4.isAxiosError = isAxiosError;
axios$5.exports = axios$4;
axios$5.exports.default = axios$4;
var axios$2 = axios$5.exports;
var axios$3 = axios$2;
...
var WebsiteSource = /* @__PURE__ */ ((WebsiteSource2) => {
  WebsiteSource2["Unknown"] = "";
  WebsiteSource2["Youtube"] = "youtube";
  return WebsiteSource2;
})(WebsiteSource || {});
var PracticeMode = /* @__PURE__ */ ((PracticeMode2) => {
  PracticeMode2["Null"] = "";
  PracticeMode2["BlankOut"] = "blankOut";
  PracticeMode2["Dictate"] = "dictate";
  return PracticeMode2;
})(PracticeMode || {});
var BackendErrorCode = /* @__PURE__ */ ((BackendErrorCode2) => {
  BackendErrorCode2[BackendErrorCode2["ExceedPracticeReviewLimit"] = 100] = "ExceedPracticeReviewLimit";
  BackendErrorCode2[BackendErrorCode2["ExceedPracticeAnalysisLimit"] = 101] = "ExceedPracticeAnalysisLimit";
...
function traverseSubsegments(indices, length) {
  let curStart = 0;
  const result = [];
  for (const [start, end] of indices) {
    if (curStart !== start) {
      result.push([0, curStart, start]);
    }
    result.push([1, start, end]);
    curStart = end;
  }
  if (curStart !== length) {
    result.push([0, curStart, length]);
  }
  return result;
}
...
function initConfig(nativeLanguage = "zh") {
  if (!nativeLanguage) {
    nativeLanguage = LanguageManager.toValidLanguageCode(chrome.i18n.getUILanguage()).length > 0 ? LanguageManager.toValidLanguageCode(chrome.i18n.getUILanguage()) : "";
  }
  return {
    nativeLanguage,
    blankOutSentences: true,
    dictateSentences: true,
    blankOutToDictateRatio: 1,
    proportionOfPractices: 0.2,
    maximumWordLimitForDictation: 12,
    maximumWordLimitForBlankOut: 30,
    showReviewButton: true,
    keepNerInPractices: true,
    preferredVocabularyTags: []
  };
}
var BexEnvironment = /* @__PURE__ */ ((BexEnvironment2) => {
  BexEnvironment2["Background"] = "background";
  BexEnvironment2["Content"] = "content";
  BexEnvironment2["Popup"] = "popup";
  BexEnvironment2["Options"] = "options";
  BexEnvironment2["Devtools"] = "devtools";
  return BexEnvironment2;
})(BexEnvironment || {});
...
class LanguageManager {
  static listLanguageNames() {
    return Object.values(Languages).map((l) => l.name);
  }
  static listLanguageInfo() {
    const result = [];
    for (const code in Languages) {
      result.push([code, Languages[code].name, Languages[code].nativeName]);
    }
    return result;
  }
  static toValidLanguageCode(code) {
  ...
  static isValidLanguageCode(code, strict = false) {
    if (strict) {
      return code in Languages;
    }
    return LanguageManager.toValidLanguageCode(code).length > 0;
  }
...
const resolveFetch$3 = (customFetch) => {
  ...
  if (customFetch) {
    ...
    _fetch = (...args) => __vitePreload(() => Promise.resolve().then(function() {
      return browser$2;
...
var nodeFetch = browser$3.exports;
...
class RealtimeChannel {
  ...
  _trigger(type, payload, ref) {
    ...
    if (["insert", "update", "delete"].includes(typeLower)) {
      (_a = this.bindings.postgres_changes) === null || _a === void 0 ? void 0 : _a.filter((bind3) => {
        var _a2, _b2, _c;
        return ((_a2 = bind3.filter) === null || _a2 === void 0 ? void 0 : _a2.event) === "*" || ((_c = (_b2 = bind3.filter) === null || _b2 === void 0 ? void 0 : _b2.event) === null || _c === void 0 ? void 0 : _c.toLocaleLowerCase()) === typeLower;
      ...
      (_b = this.bindings[typeLower]) === null || _b === void 0 ? void 0 : _b.filter((bind3) => {
        ...
        if (["broadcast", "presence", "postgres_changes"].includes(typeLower)) {
          if ("id" in bind3) {
            ...
            const bindEvent = (_a2 = bind3.filter) === null || _a2 === void 0 ? void 0 : _a2.event;
  ...
  _off(type, filter) {
    ...
    this.bindings[typeLower] = this.bindings[typeLower].filter((bind3) => {
      var _a;
      return !(((_a = bind3.type) === null || _a === void 0 ? void 0 : _a.toLocaleLowerCase()) === typeLower && RealtimeChannel.isEqual(bind3.filter, filter));
    });
    return this;
  }
...
const resolveResponse = () => __awaiter$5(void 0, void 0, void 0, function* () {
  if (typeof Response === "undefined") {
    return (yield __vitePreload(() => Promise.resolve().then(function() {
      return browser$2;
    }), true ? void 0 : void 0)).Response;
  }
  return Response;
});
...
const resolveHeadersConstructor = () => {
  if (typeof Headers === "undefined") {
    return browser$3.exports.Headers;
  }
  return Headers;
};
...
const supabaseUrl = "https://ogmjutnnxjnukpzcsmwv.supabase.co";
const supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9nbWp1dG5ueGpudWtwemNzbXd2Iiwicm9sZSI6ImFub24iLCJpYXQiOjE2OTg4NDk1OTgsImV4cCI6MjAxNDQyNTU5OH0.YWcUK9LLhUhty7oWHZ_6jN808mGUzQr5u36mSx3dqyg";
let supabase;
...
async function setSupabaseTokens(access_token, refresh_token) {
  if (supabase) {
    ...
    return new Promise((resolve) => {
      chrome.runtime.sendMessage(
        chrome.runtime.id,
        { message: "set-supabase-session", session: { access_token, refresh_token } },
        (res) => {
          if (res) {
            resolve(res);
          } else {
...
function supabaseSignOut() {
  if (supabase) {
    ...
    chrome.runtime.sendMessage(chrome.runtime.id, { message: "supabase-sign-out" });
  }
  setUserInfo(void 0);
}
async function getLocalConfig(initialConfig = void 0) {
  if (!initialConfig) {
...
async function updateConfig(newConfig) {
  ...
  if (userLogin) {
    try {
      const res = await api.post("/user-config", newConfig);
      success = res.success;
    } catch (err) {
      console.log(err);
      success = false;
...
async function getRemoteConfig(initialConfig = void 0) {
  if (!initialConfig) {
    initialConfig = initConfig();
  }
  let config2;
  ...
  if (res.success) {
    ...
    config2 = initialConfig;
    if (res.code === 404) {
      api.post("/user-config", config2);
    }
  }
  return config2;
}
async function getConfig(fromRemote = false) {
  const isLogin = await checkLogin();
  const initialConfig = initConfig();
  let config2 = void 0;
  if (isLogin && fromRemote) {
    config2 = await getRemoteConfig(initialConfig);
  } else {
    config2 = await getLocalConfig(initialConfig);
    if (!config2) {
      config2 = initialConfig;
    }
  }
  if (Object.keys(initialConfig).some((k) => !(config2 == null ? void 0 : config2.hasOwnProperty(k)))) {
...
async function fetchAdapter(config2) {
  ...
  const promiseChain = [getResponse(request2, config2)];
    ...
    promiseChain.push(
      new Promise((res) => {
        setTimeout(() => {
          ...
          res(createError2(message, config2, "ECONNABORTED", request2));
        }, config2.timeout);
      })
    );
  }
  ...
  return new Promise((resolve, reject) => {
    if (data instanceof Error) {
      ...
      Object.prototype.toString.call(config2.settle) === "[object Function]" ? config2.settle(resolve, reject, data) : settle$1(resolve, reject, data);
    }
  });
}
async function getResponse(request2, config2) {
  ...
  try {
    ...
    return createError2("Network Error", config2, "ERR_NETWORK", request2);
  }
  const response = {
    ok: stageOne.ok,
...
function createRequest(config2) {
  ...
  if (method !== "GET" && method !== "HEAD") {
    ...
    if (utils$d.isFormData(options.body) && utils$d.isStandardBrowserEnv()) {
      headers.delete("Content-Type");
    }
  }
  if (config2.mode) {
    options.mode = config2.mode;
  }
  if (config2.cache) {
    options.cache = config2.cache;
  }
  if (config2.integrity) {
    options.integrity = config2.integrity;
  }
  if (config2.redirect) {
    options.redirect = config2.redirect;
  }
  if (config2.referrer) {
    options.referrer = config2.referrer;
  }
  if (!utils$d.isUndefined(config2.withCredentials)) {
    options.credentials = config2.withCredentials ? "include" : "omit";
  }
  const fullPath = buildFullPath$1(config2.baseURL, config2.url);
  const url = buildURL$2(fullPath, config2.params, config2.paramsSerializer);
  return new Request(url, options);
}
function createError2(message, config2, code, request2, response) {
  if (axios$3.AxiosError && typeof axios$3.AxiosError === "function") {
    return new axios$3.AxiosError(message, axios$3.AxiosError[code], config2, request2, response);
  }
  var error = new Error(message);
  return enhanceError2(error, config2, code, request2, response);
}
function enhanceError2(error, config2, code, request2, response) {
  error.config = config2;
  if (code) {
    error.code = code;
  }
...
const baseURL = "https://pact-english-mxplp.ondigitalocean.app";
const api = axios$3.create({ baseURL });
api.interceptors.request.use(
  async (config2) => {
    var _a, _b;
    if (detectBexEnvironment() === BexEnvironment.Background || ((_a = config2.params) == null ? void 0 : _a.useFetch) === true) {
      config2.adapter = fetchAdapter;
    } else {
      config2.adapter = axios$3.defaults.adapter;
    }
    if (((_b = config2.params) == null ? void 0 : _b.addAccessToken) === false)
      return config2;
    const tokens = await getSupabaseTokens();
    if (!tokens.access_token || !tokens.refresh_token) {
      return Promise.reject(new UnauthorizedError());
    }
    config2.headers.Authorization = `Bearer ${tokens.access_token}`;
    return config2;
  },
  (error) => {
    return Promise.reject(error);
  ...
  async (error) => {
    ...
    if ((error instanceof UnauthorizedError || error.response.status === 401) && originalRequest && (!originalRequest.hasOwnProperty("_retry") || !originalRequest._retry)) {
      ...
      if (tokens.access_token) {
        ...
        setUserInfo(void 0);
        return Promise.reject(new AuthError$1());
      }
    }
    return Promise.reject(error);
  }
...
var axios = boot(({ app }) => {
  app.config.globalProperties.$axios = axios$3;
...
export { BackendErrorCode as B, LanguageManager as L, PracticeMode as P, WebsiteSource as W, getUserInfo as a, supabaseSignOut as b, checkLogin as c, getConfig as d, supabaseUrl as e, setSupabaseTokens as f, getAugmentedNamespace as g, api as h, updateConfig as i, initConfig as j, getSupabaseTokens as k, updateUserInfo as l, traverseSubsegments as m, axios$1 as n, parseJwt as p, setUserInfo as s, timestampToDateStr as t, uniqueBy as u };
